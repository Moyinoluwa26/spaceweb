  ...
  function Douglas () {
    return ( <div className='flex mt-8 md:mt-0  md:flex-row flex-col-reverse w-9/12 md:mr-9   '>
      <div className='md:w-1/2 flex flex-col '>
        ...
        <p className='text-lg bg-black '>Douglas Gerald Hurley is an American engineer, former Marine Corps pilot and former NASA astronaut. He launched into space for the third time as commander of Crew Dragon Demo-2.</p>
      </div>
